...
public final class Constants {
  ...
  public static final class FuelConstants {
    ...
    public static final int INTAKE_LAUNCHER_MOTOR_ID = 8;
    ...
    public static final double INTAKING_INTAKE_VOLTAGE = 2;
    public static final double LAUNCHING_FEEDER_VOLTAGE = 4;
    public static final double LAUNCHING_LAUNCHER_VOLTAGE = 3.5;
    public static final double SPIN_UP_FEEDER_VOLTAGE = -3.5;
